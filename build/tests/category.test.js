...
describe("GET, /categories", () => {
    test("NO CONTENT, cuando no hay ninguna categoría", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield API.get("/categories").send();
        expect(response.status).toBe(handleHttpException_1.HttpStatus.NO_CONTENT);
    }));
    test("OK, cuando hay al menos una categoría", () => __awaiter(void 0, void 0, void 0, function* () {
